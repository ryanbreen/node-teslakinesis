...
module ActionView::Helpers::DateHelper
  def precise_distance_of_time_in_words(from_time, to_time)
    ...
    distance_in_minutes = ((total_distance_in_seconds - (distance_in_hours*60.0*60.0))/60.0).floor
    distance_in_seconds = (total_distance_in_seconds - (distance_in_hours*60.0*60.0) - (distance_in_minutes*60.0)).floor
